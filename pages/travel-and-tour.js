...
export default function TravelAndTours() {
  return (
    <div>
      <MainLayout pageTitle="Travel & Tours">
        <>

           <UnderConstruction/>
        {/* <div className="contact__center__overlay">
            <h4 className="text-center">Travel Transportation & Hospitality </h4>
          </div>
          <div class="container">
            <div className="row consumer__pt">
            ...
            <div className="row consumer__pt consumer__pt__last">
              <div className="col-lg-6 col-12">
                <img
                  className="card-img-top"
                  src="img/tth3.png"
